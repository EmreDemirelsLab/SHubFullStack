...
class Program
{
    ...
    {
        Console.WriteLine("Konu10Structyapilar");
        string degisken;
        char karakter = 'a'; 
...

    {
        ...
        {
            Console.WriteLine(s[i]); // s değişkenin i. indexindeki değeri yazdır.
        }
    ...
    static void StringMetotlari()
    {
        ...
        Console.WriteLine("metin in karakter sayısı: " + metin.Length);
        Console.WriteLine();
